...
export default async function decorate(block) {
  ...
  // Optional: Click outside to close the dropdowns
  // document.addEventListener('click', (event) => {
  //   allDivs.forEach((div) => {
  //     const secondDiv = div.querySelector('.dropdown-content');
  //     const firstDiv = div.querySelector('.tooltip-trigger');
  //     if (secondDiv && firstDiv && !firstDiv.contains(event.target) && !secondDiv.contains(event.target)) {
  //       secondDiv.style.display = 'none';
