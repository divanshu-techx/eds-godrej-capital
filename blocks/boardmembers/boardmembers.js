  ...
  anchors.forEach((anchor) => {
    ...
    fetch(url)
      ...
      .then((html) => {
        ...
        // Add custom classes to child elements of profiles div
        ...
        const profilePictures = profileDiv.querySelectorAll('picture img');
        profilePictures.forEach((profilePicture) => {
          profilePicture.addEventListener('click', () => {
            ...
            popupContent.appendChild(profileClone);
            popup.appendChild(popupContent);
