...
export default async function decorate(block) {
  ...
  console.log('my footer js called');
  ...
  const subfooterItems = document.querySelectorAll('.subfooter .footer-item');
  // Loop through each .footer-item
  subfooterItems.forEach((item) => {
  ...
  footerItemsclick.forEach((footerItemList) => {
    const itemDiv = footerItemList.querySelector('.item');
    const contentDiv = footerItemList.querySelector('.content.hidden');
