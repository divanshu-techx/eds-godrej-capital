...
function getHtmlData(newMetaData) {
  const htmlCode = `
    <div class="calculator-container-tax-saving">
        ...
        <div class="inputTaxSaving">
            <div class="inputBoxTaxSavingLabel">
                ...
                <span id="inputLabel_tax_saving">${
                  newMetaData.yearSymbol
                }</span>
                <span id="age"  class="inputSpan_tax_saving" contenteditable="true" data-min="${
                  newMetaData.ageMin
                }" data-max="${newMetaData.ageMax}" onblur="updateDisplay()">${
    newMetaData.ageMin
  }</span>
                </div>
            </div>
            <div class="inputBoxTaxSavingRange">
            <input type="range" id="ageRange" min="${
              newMetaData.ageMin
            }" max="${newMetaData.ageMax}" value="${
    newMetaData.ageMin
            ...
            <div class="errorMsg_tax_saving">
                <p id="ageError" class="error_text" style="display: none;">Value must be between ${
                  newMetaData.ageMin
         ...
         <div class="inputTaxSaving">
            <div class="inputBoxTaxSavingLabel">
                ...
                <span id="income" class="inputSpan_tax_saving" contenteditable="true" data-min="${
                  newMetaData.totalTaxMin
                }" data-max="${
    newMetaData.totalTaxMax
    ...
    newMetaData.totalTaxMin
            ...
            <div class="inputBoxTaxSavingRange">
            <input type="range" id="incomeRange" min="${
              newMetaData.totalTaxMin
            }" max="${newMetaData.totalTaxMax}" value="${
    newMetaData.totalTaxMin
            ...
            <div class="errorMsg_tax_saving">
                <p id="incomeError" class="error_text" style="display: none;">Value must be between ${
                  newMetaData.totalTaxMin
            ...
            <div class="inputBoxTaxSavingLabel">
                <label for="principal">${
                  newMetaData.principalTitleAnnual
                }</label>
                <div class="tax_saving_input_label">
                <span id="tax_saving_principal_label">${
                  newMetaData.rupeeSymbolEng
                }</span>
                <span id="principal" class="inputSpan_tax_saving" contenteditable="true" data-min="${
                  newMetaData.principalMinAnnual
                }" data-max="${
    newMetaData.principalMaxAnnual
  }" onblur="updateDisplay()">${formatNumberToIndianCommas(
    newMetaData.principalMinAnnual
  )}</span>
                </div>
            ...
            <div class="inputBoxTaxSavingRange">
            <input type="range" id="principalRange" min="${
              newMetaData.principalMinAnnual
            }" max="${newMetaData.principalMaxAnnual}" value="${
    newMetaData.principalMinAnnual
            ...
            <div class="errorMsg_tax_saving">
                <p id="principalError" class="error_text" style="display: none;">Value must be between ${
                  newMetaData.principalMinAnnual
            ...
            <div class="inputBoxTaxSavingLabel">
                ...
                <span id="interest" class="inputSpan_tax_saving" contenteditable="true" data-min="${
                  newMetaData.interestMinAnnual
                }" data-max="${
    newMetaData.interestMaxAnnual
  }" onblur="updateDisplay()">${formatNumberToIndianCommas(
    newMetaData.interestMinAnnual
  )}</span>
            </div>
            ...
            <div class="inputBoxTaxSavingRange">
            <input type="range" id="interestRange" min="${
              newMetaData.interestMinAnnual
            }" max="${newMetaData.interestMaxAnnual}" value="${
    newMetaData.interestMinAnnual
            ...
            <div class="errorMsg_tax_saving">
                <p id="interestError" class="error_text" style="display: none;">Value must be between ${
                  newMetaData.interestMinAnnual
        ...
        <div class="outputs_tax_saving">
            ...
            <div class="result_tax_cess_result">
                <div class="cessRate">Income Tax Payable Includes ${
                  newMetaData.cessTaxRate
